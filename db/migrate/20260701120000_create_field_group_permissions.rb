...
class CreateFieldGroupPermissions < ActiveRecord::Migration[8.0]
  def change
    create_table :field_group_permissions do |t|
      ...
      t.index %i[type_id field_group status_id role],
              unique: true,
              name: "index_field_group_permissions_unique"
    end
  end
end
